...
The lab should should have given you some insight into how photosynthesis will respond to global change drivers (e.g. temperature). With these insights can you answer the following:

**Q. Can you highlight one of the causes of the poor prediction from the light-use efficiency model? What could you adjust to improve the model prediction?**

**Q. What do you predict will happen to the future land carbon sink (uptake) if [CO~2~] keeps increasing?**

**Q. How will this predictions be affected by increasing temperature?**

**Q. Can you think of at one important factor you didn't account for in your modelling? How would it change predictions?**
